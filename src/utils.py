...
satellite_data = pd.DataFrame(
    [
        {
            "Satellite": "Aqua",
            "Availability": "31-Dec-2003 - 31-Dec-2019",
            "Resolution": "500 m",
        },
        {
            "Satellite": "CartoSat-1",
            "Availability": "8-May-2005 - 19-Feb-2019",
            "Resolution": "2.5 m",
        },
        {
            "Satellite": "CartoSat-2",
            "Availability": "14-Apr-2007 - 23-May-2019",
            "Resolution": "0.8 m",
        },
        {
            "Satellite": "CartoSat-2C",
            "Availability": "1-Mar-2016 - till date",
            "Resolution": "0.65 m - 1.6 m",
        },
        {
            "Satellite": "CartoSat-2D",
            "Availability": "17-Feb-2017 - till date",
            "Resolution": "0.65 m - 1.6 m",
        },
        {
            "Satellite": "CartoSat-2E",
            "Availability": "25-Jun-2017 - till date",
            "Resolution": "0.65 m - 1.6 m",
        },
        {
            "Satellite": "CartoSat-2F",
            "Availability": "15-Jun-2018 - till date",
            "Resolution": "0.65 m - 1.6 m",
        },
        {
            "Satellite": "CartoSat-3",
            "Availability": "10-Jun-2020 - till date",
            "Resolution": "0.28 m - 1.1 m",
        },
        {
            "Satellite": "EOS-04",
            "Availability": "23-Mar-2022 - till date",
            "Resolution": "3 m - 33 m",
        },
        {
            "Satellite": "EOS-06",
            "Availability": "1-Apr-2023 - till date",
            "Resolution": "360 m",
        },
        {
            "Satellite": "IRS-1A",
            "Availability": "4-Apr-1988 - 28-May-1991",
            "Resolution": "36 m - 73 m",
        },
        {
            "Satellite": "IRS-1B",
            "Availability": "2-Oct-1991 - 9-Sep-2001",
            "Resolution": "36 m - 73 m",
        },
        {
            "Satellite": "IRS-1C",
            "Availability": "14-Nov-1996 - 20-Sep-2007",
            "Resolution": "5.8 m - 56 m",
        },
        {
            "Satellite": "IRS-1D",
            "Availability": "1-Jan-1998 - 20-Sep-2007",
            "Resolution": "5.8 m - 56 m",
        },
        {
            "Satellite": "JPSS1",
            "Availability": "15-Jan-2021 - till date",
            "Resolution": "375 m - 750 m",
        },
        {
            "Satellite": "KompSat-3",
            "Availability": "1-Jan-2018 - 29-May-2020",
            "Resolution": "0.55 m",
        },
        {
            "Satellite": "KompSat-3A",
            "Availability": "1-Jan-2018 - 31-May-2020",
            "Resolution": "0.55 m",
        },
        {
            "Satellite": "LandSat-8",
            "Availability": "1-Jan-2017 - till date",
            "Resolution": "30 m",
        },
        {
            "Satellite": "LandSat-9",
            "Availability": "1-Apr-2022 - till date",
            "Resolution": "30 m",
        },
        {
            "Satellite": "NOAA-11",
            "Availability": "25-Aug-1994 - 13-Sep-1994",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-12",
            "Availability": "14-Sep-1994 - 4-Nov-1995",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-14",
            "Availability": "3-Apr-1995 - 22-Sep-2010",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-16",
            "Availability": "20-Jun-2001 - 11-Aug-2005",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-17",
            "Availability": "20-Sep-2005 - 13-Apr-2010",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-18",
            "Availability": "1-Oct-2005 - 9-Oct-2009",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "NOAA-19",
            "Availability": "29-Apr-2010 - 29-Oct-2014",
            "Resolution": "1000 m",
        },
        {
            "Satellite": "Novasar-1",
            "Availability": "1-Oct-2019 - till date",
            "Resolution": "6 m - 30 m",
        },
        {
            "Satellite": "OceanSat-1",
            "Availability": "1-Jul-1999 - 29-Jul-2009",
            "Resolution": "360 m",
        },
        {
            "Satellite": "OceanSat-2",
            "Availability": "31-Dec-2009 - 3-May-2023",
            "Resolution": "360 m",
        },
        {
            "Satellite": "RISAT-1",
            "Availability": "1-Jul-2012 - 30-Sep-2016",
            "Resolution": "3 m - 30 m",
        },
        {
            "Satellite": "ResourceSat-1",
            "Availability": "7-Dec-2003 - 18-Nov-2023",
            "Resolution": "5.8 m - 56 m",
        },
        {
            "Satellite": "ResourceSat-2",
            "Availability": "8-May-2011 - till date",
            "Resolution": "5.8 m - 24 m",
        },
        {
            "Satellite": "ResourceSat-2A",
            "Availability": "18-Dec-2016 - till date",
            "Resolution": "5.8 m - 56 m",
        },
        {
            "Satellite": "Sentinel-1A",
            "Availability": "9-Oct-2019 - till date",
            "Resolution": "20 m",
        },
        {
            "Satellite": "Sentinel-1B",
            "Availability": "4-Oct-2019 - 23-Dec-2021",
            "Resolution": "20 m",
        },
        {
    ...
    try:
        ...
        if file_extension.lower() == ".zip":
            for root, dirs, files in os.walk(
                os.path.join(tempfile.gettempdir(), file_id), topdown=False
            ):
                for name in files:
        ...
        if option == optionsList[0]:
            ...
            if url_data == "":
                ...
                mapObject.add_gdf(
                    gdf,
                    zoom_to_layer=True,
                    layer_name=f"{url_data.split('/')[-1].split('.')[0]}",
                )
            ...
            if uploaded_file is not None:
                try:
                    ...
                    mapObject.add_gdf(
                        gdf,
                        zoom_to_layer=True,
                        layer_name=f"{uploaded_file.name.split('.')[0]}",
                    )
...
def set_params():
    with st.expander("Define Processing Parameters"):
        ...
        if toDate - fromDate < timedelta(days=10):
            st.warning(
                "Difference between selected dates is too small. There might not be any scenes available!"
            )
...
def filter_openData(results: List[Dict]):
    scenes = []
    for res in results:
        if res.get("PRICED") == "OpenData_DirectDownload":
            scenes.append(res)
    return scenes
...
def process_request():
    if isinstance(st.session_state["aoi"], gpd.GeoDataFrame):
        ...
        response = requests.post(
            ...
            json=create_payload(
                st.session_state["aoi"],
                start_date=st.session_state["fromDate"],
                end_date=st.session_state["toDate"],
                product="Standard",
            ),
        )
        ...
        if response.status_code == 200:
            data = response.json()
            scenes = filter_openData(data["Results"])
            st.session_state["response"] = scenes
            st.session_state["total_scenes"] = len(scenes)
            st.write(f"Scenes found: {len(scenes)}")
        else:
